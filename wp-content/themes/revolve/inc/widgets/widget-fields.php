...
function revolve_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    ...
    switch ($revolve_widgets_field_type) {
        ...
        case 'text' :
            ?>
            <p>
                <label for="<?php echo $instance->get_field_id($revolve_widgets_name); ?>"><?php echo $revolve_widgets_title; ?>:</label>
                <input class="widefat" id="<?php echo $instance->get_field_id($revolve_widgets_name); ?>" name="<?php echo $instance->get_field_name($revolve_widgets_name); ?>" type="text" value="<?php echo $athm_field_value; ?>" />

                <?php if (isset($revolve_widgets_description)) { ?>
                    <br />
                    <small><?php echo $revolve_widgets_description; ?></small>
                <?php } ?>
            </p>
            <?php
            break;
        ...
        case 'textarea' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($revolve_widgets_name); ?>"><?php echo $revolve_widgets_title; ?>:</label>
                <textarea class="widefat" rows="<?php echo $revolve_widgets_row; ?>" id="<?php echo $instance->get_field_id($revolve_widgets_name); ?>" name="<?php echo $instance->get_field_name($revolve_widgets_name); ?>"><?php echo $athm_field_value; ?></textarea>
            </p>
            <?php
            break;
        ...
        case 'checkbox' :
            ?>
            <p>
                <input id="<?php echo $instance->get_field_id($revolve_widgets_name); ?>" name="<?php echo $instance->get_field_name($revolve_widgets_name); ?>" type="checkbox" value="1" <?php checked('1', $athm_field_value); ?>/>
                <label for="<?php echo $instance->get_field_id($revolve_widgets_name); ?>"><?php echo $revolve_widgets_title; ?></label>
        ...
        case 'radio' :
            ...
            <p>
                <?php
                echo $revolve_widgets_title;
                echo '<br />';
                foreach ($revolve_widgets_field_options as $athm_option_name => $athm_option_title) {
                    ?>
                    <input id="<?php echo $instance->get_field_id($athm_option_name); ?>" name="<?php echo $instance->get_field_name($revolve_widgets_name); ?>" type="radio" value="<?php echo $athm_option_name; ?>" <?php checked($athm_option_name, $athm_field_value); ?> />
        ...
        case 'select' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($revolve_widgets_name); ?>"><?php echo $revolve_widgets_title; ?>:</label>
                <select name="<?php echo $instance->get_field_name($revolve_widgets_name); ?>" id="<?php echo $instance->get_field_id($revolve_widgets_name); ?>" class="widefat">
                    <?php foreach ($revolve_widgets_field_options as $athm_option_name => $athm_option_title) { ?>
        ...
        case 'number' :
            ?>
            <p>
                <label for="<?php echo $instance->get_field_id($revolve_widgets_name); ?>"><?php echo $revolve_widgets_title; ?>:</label><br />
                <input name="<?php echo $instance->get_field_name($revolve_widgets_name); ?>" type="number" step="1" min="1" id="<?php echo $instance->get_field_id($revolve_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" class="small-text" />
            ...
            <p>
                ...
                <select name="<?php echo $instance->get_field_name($revolve_widgets_name); ?>" id="<?php echo $instance->get_field_id($revolve_widgets_name); ?>" class="widefat">
                    <?php foreach ($revolve_postlist as $revolve_single_post) { ?>
                        <option value="<?php echo $revolve_single_post['value']; ?>" id="<?php echo $instance->get_field_id($revolve_single_post['label']); ?>" <?php selected($revolve_single_post['value'], $athm_field_value); ?>><?php echo $revolve_single_post['label']; ?></option>
                    <?php } ?>
                </select>
        ...
        case 'upload' :
            ...
            $output = '';
            $id = $instance->get_field_id($revolve_widgets_name);
            $class = '';
            $int = '';
            $value = $athm_field_value;
            $name = $instance->get_field_name($revolve_widgets_name);
            ...
            $output .= '<label for="' . $instance->get_field_id($revolve_widgets_name) . '">' . $revolve_widgets_title . '</label><br/>';
            $output .= '<input id="' . $id . '" class="upload' . $class . '" type="text" name="' . $name . '" value="' . $value . '" placeholder="' . __('No file chosen', 'revolve') . '" />' . "\n";
            if (function_exists('wp_enqueue_media')) {
                if (( $value == '')) {
                    $output .= '<input id="upload-' . $id . '" class="upload-button button" type="button" value="' . __('Upload', 'revolve') . '" />' . "\n";
                } else {
                    $output .= '<input id="remove-' . $id . '" class="remove-file button" type="button" value="' . __('Remove', 'revolve') . '" />' . "\n";
                }
            } else {
                $output .= '<p><i>' . __('Upgrade your version of WordPress for full media support.', 'revolve') . '</i></p>';
            }

            $output .= '<div class="screenshot team-thumb" id="' . $id . '-image">' . "\n";

            if ($value != '') {
                $remove = '<a class="remove-image">'. __('Remove', 'revolve').'</a>';
        ...
        case 'icon' :
            ...
            <p>
                ...
                <input class="hidden-icon-input" name="<?php echo $instance->get_field_name($revolve_widgets_name); ?>" type="hidden" id="<?php echo $instance->get_field_id($revolve_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" />
